    ...
    return ( 
        ...
        <Link to={`/artistas/${_id}`}>
            <div className="w-36 h-36 m-5 flex flex-col justify-start items-center pt-3 relative rounded-md overflow-hidden" style={{backgroundColor: randomColor}}>
                ...
                <img src={capa === "capa.jpg"? image : "/capa.jpg"} alt="Capa do Album" className="w-2/3 h-2/3 absolute bottom-0 -right-2 rounded-sm rotate-[25deg] translate-x-[18%] translate-y-[-2%]" />
            </div>
        </Link>
     );
}
